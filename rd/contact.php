...
if($_POST)
{
    $to_Email   	= "youremail@website.com"; //Replace with recipient email address
    ...
    */
    ...
    if(!$sentMail)
    {
        $output = json_encode(array('type'=>'error', 'text' => 'Could not send mail! Please check your PHP version or mail configuration.'));
        die($output);
    }else{
